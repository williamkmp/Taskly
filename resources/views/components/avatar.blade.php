...
<div data-role="avatar"
    {{ $attributes->merge(['class' => 'relative aspect-square flex flex-wrap items-center justify-center gap-2 overflow-hidden text-lg font-semibold text-center text-white bg-black rounded-full cursor-default select-none']) }}>
